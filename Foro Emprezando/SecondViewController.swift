...
class SecondViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    //let descriptionTextView = ["\(descripcion)", "\(descripcion2)", "\(descripcion3)", "\(descirpcion4)", "\(descirpcion5)", "\(descripcion6)", "\(descripcion7)", "\(descripcion8)"]
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        //cell.prgramaTextView?.attributedText = self.descriptionTextView[indexPath.row]
